  ...
  return (
    <div className="container max-w-6xl py-6 space-y-6">
      ...
      <div className="grid grid-cols-[300px_1fr] gap-6">
        <Card className="border-none shadow-lg rounded-[2rem] h-[calc(100vh-12rem)]">
                ...
                {participants.map((participant) => (
                  ...
                  >
                    <div className="relative">
                      <Avatar className="h-8 w-8 border-2 border-purple-100 dark:border-purple-800">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-medium flex items-center gap-2">
                        {participant.name}
                        {participant.isAdmin && (
                          <span className="px-2 py-0.5 text-xs bg-purple-100 dark:bg-purple-900/40 text-purple-600 dark:text-purple-400 rounded-full">
                            Admin
                          </span>
                        )}
                      </span>
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  <motion.div
                    ...
                    className={`flex gap-4 ${message.author.name === "You" ? "flex-row-reverse" : ""}`}
                  >
                    <Avatar className="h-8 w-8 border-2 border-purple-100 dark:border-purple-800">
                    ...
                    <div className={`flex flex-col gap-1 ${message.author.name === "You" ? "items-end" : ""}`}>
                      ...
                      <div className={`rounded-2xl px-4 py-2 max-w-[300px] ${
            ...
            <div className="p-4 border-t bg-white dark:bg-gray-950">
              <div className="flex gap-2">
                ...
                <Input
                  ...
                  className="rounded-full bg-purple-50/50 dark:bg-purple-900/10 border-0 focus-visible:ring-purple-500"
                  onKeyDown={(e) => {
